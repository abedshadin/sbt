...
<td><input type="text" name="liquid[]"  ></td>
<td><input type="text" name="est_cost[]"  ></td>
<td><select name="loc[]" >
...
if (isset($_POST['mod'])) {
    ...
    foreach ($id as $key => $value) {
        ...
        $query = "INSERT INTO ltm (id, name_work, s_rate, bd, l_sell_time, l_secure_time, c_date_t, liquid, est_cost, loc) 
                  VALUES ('$value', '{$name_work[$key]}', '{$s_rate[$key]}', '{$bd[$key]}', '$formatted_l_sell', '$formatted_l_secure_time', '$formatted_c_date_t', '{$liquid[$key]}', '{$est_cost[$key]}', '{$loc[$key]}')";
